#########################################################################
# Interrupted Time-series Analysis on Social-economic factors in bridge-connected cities
# Yuting Zou
# March 2020
#########################################################################
...
setwd('D:/college/Thesis/R code/data/InterruptedTime-seriesAnalysis/ITSA_SocialEconomicFactors')

#################################### Part2: Load data from the file #####################################
Facx1 <- read.csv('X1JNWithoutControl.csv',header = T)
Facx2 <- read.csv('X2JNWithoutControl.csv',header = T)
Facx3 <- read.csv('X3JNWithoutControl.csv',header = T)
Facx4 <- read.csv('X4JNWithoutControl.csv',header = T)
Facx5 <- read.csv('X5JNWithoutControl.csv',header = T)
Facx6 <- read.csv('X6JNWithoutControl.csv',header = T)
Facx7 <- read.csv('X7JNWithoutControl.csv',header = T)
Facx8 <- read.csv('X8JNWithoutControl.csv',header = T)
Facx9 <- read.csv('X9JNWithoutControl.csv',header = T)
Facx10 <- read.csv('X10JNWithoutControl.csv',header = T)
Facx11 <- read.csv('X11JNWithoutControl.csv',header = T)
...
# X9
modelLinear9 <- lm(x9~time + level + trend, data = Facx9) 
summary(modelLinear9)
Confint(modelLinear9)
coef(modelLinear9)
...
# X11
modelLinear11 <- lm(x11~time + level + trend, data = Facx11) 
summary(modelLinear11)
Confint(modelLinear11)
coef(modelLinear11)
...
# Plot ACF and PACF  for x11
par(mfrow=c(1,2))
# Produce plots
acf(residuals(modelLinear11))
acf(residuals(modelLinear11),type='partial')
# Note decay in ACF, significant spike at 4 in PACF, model p=4
...
# Fit the GLS regression model for x11
Model11<- gls(x11 ~ time + level + trend,
              data=Facx11,
              correlation = NULL,
              method="ML") #p=q=0
summary(Model11)
...
plot(Facx1$time, Facx1$x1,
     ylab = 'IN1 (Ningbo & Jiaxing)',
     ylim = c(100,500),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for IN1 in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
plot(Facx2$time, Facx2$x2,
     ylab = 'IN2 (Ningbo & Jiaxing)',
     ylim = c(700,8000),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for IN2 in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
plot(Facx3$time, Facx3$x3,
     ylab = 'IN3 (Ningbo & Jiaxing)',
     ylim = c(300,8000),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for IN3 in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
plot(Facx4$time, Facx4$x4,
     ylab = 'CGDP (Ningbo & Jiaxing)',
     ylim = c(30000,300000),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for CGDP in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
# x5: POP
par(mfrow=c(1,1))
plot(Facx5$time, Facx6$x5,
     ylab = 'POP (Ningbo & Jiaxing)',
     ylim = c(830,980),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for POP in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
plot(Facx6$time, Facx6$x6,
     ylab = 'IFA (Ningbo & Jiaxing)',
     ylim = c(500,9000),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for IFA in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
# x7: IRED
par(mfrow=c(1,1))
plot(Facx7$time, Facx14$x7,
     ylab = 'IRED (Ningbo & Jiaxing)',
     ylim = c(50,3000),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for IRED in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
plot(Facx8$time, Facx8$x8,
     ylab = 'TOUR (Ningbo & Jiaxing)',
     ylim = c(90,3500),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for TOUR in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
...
abline(v=9.5,lty = 2)
# Plot the first line segment
lines(Facx9$time[1:9], fitted(Model9)[1:9], col="red",lwd=2)
# Plot the second line segmentModelRE
lines(Facx9$time[10:18], fitted(Model9)[10:18], col="red",lwd=2)
# And the counterfactual
segments(1,
         Model9$coef[1]+Model9$coef[2],
         18,
         Model9$coef[1]+Model9$coef[2]*18,
         lty=2,
         lwd=2,
         col='red')
...
abline(v=9.5,lty = 2)
# Plot the first line segment
lines(Facx18$time[1:9], fitted(Model10)[1:9], col="red",lwd=2)
# Plot the second line segmentModelRE
lines(Facx18$time[10:18], fitted(Model10)[10:18], col="red",lwd=2)
# And the counterfactual
segments(1,
...
# x11: GOAFAF
par(mfrow=c(1,1))
plot(Facx11$time, Facx19$x11,
     ylab = 'GOAFAF (Ningbo & Jiaxing)',
     ylim = c(100,900),
     xlab = 'year',
     type = 'l',
     col = 'red',
     xaxt = 'n',
     main = 'ITSA for GOAFAF in Ningbo & Jiaxing from 2000-2017',
     cex.main = 1.5)
axis(1, at=1:18, labels = Facx11$year)
points(Facx11$time,Facx11$x11,
       col = 'red',
       pch = 20)
abline(v=9.5,lty = 2)
# Plot the first line segment
lines(Facx11$time[1:9], fitted(Model11)[1:9], col="red",lwd=2)
# Plot the second line segmentModelRE
lines(Facx11$time[10:18], fitted(Model11)[10:18], col="red",lwd=2)
# And the counterfactual
segments(1,
         Model11$coef[1]+Model11$coef[2],
         18,
         Model11$coef[1]+Model11$coef[2]*18,
         lty=2,
         lwd=2,
         col='red')
